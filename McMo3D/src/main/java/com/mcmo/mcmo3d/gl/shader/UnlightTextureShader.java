...
public class UnlightTextureShader extends AShader{
    public int mMVPHandler;
    public int mPositionHandler;
    public int mTexCoorHandler;
    public SimpleTexture texture;
    private Bitmap bitmap;
    public UnlightTextureShader(Resources resources,Bitmap bitmap) {
        super(R.raw.shader_unlit_v, R.raw.shader_unlit_f, resources);
        this.bitmap=bitmap;
    ...
    public void changeTexture(Bitmap bitmap){
        TextureUtil.createImageTexture(bitmap,texture.getTextureId());
    }
